...
increment_value key tree = case (split_key key, tree) of
   -- start by matching up cases where this tree doesnt exist yet
   ((0, 0), NullNode)   -> RadixTrieNode Nothing (new_inc_node NullNode) NullNode NullNode NullNode
   ((1, 0), NullNode)   -> RadixTrieNode Nothing NullNode (new_inc_node NullNode) NullNode NullNode
   ((2, 0), NullNode)   -> RadixTrieNode Nothing NullNode NullNode (new_inc_node NullNode) NullNode
   ((3, 0), NullNode)   -> RadixTrieNode Nothing NullNode NullNode NullNode (new_inc_node NullNode)

   -- this tree still doesnt exist, but the indexed value is deeper than the next level down
   ((0, r), NullNode)   -> RadixTrieNode Nothing (increment_value r NullNode) NullNode NullNode NullNode
   ((1, r), NullNode)   -> RadixTrieNode Nothing NullNode (increment_value r NullNode) NullNode NullNode
   ((2, r), NullNode)   -> RadixTrieNode Nothing NullNode NullNode (increment_value r NullNode) NullNode
   ((3, r), NullNode)   -> RadixTrieNode Nothing NullNode NullNode NullNode (increment_value r NullNode)

   -- ok, now the tree exists and I am searching for my child  
   ((0, 0),        _)   -> RadixTrieNode (nodeValue tree) (new_inc_node $ node0 tree) (node1 tree) (node2 tree) (node3 tree)
   ((1, 0),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (new_inc_node $ node1 tree) (node2 tree) (node3 tree)
   ((2, 0),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (node1 tree) (new_inc_node $ node2 tree) (node3 tree)
   ((3, 0),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (node1 tree) (node2 tree) (new_inc_node $ node3 tree)

   -- the tree exists but my target is deeper
   ((0, r),        _)   -> RadixTrieNode (nodeValue tree) (increment_value r (node0 tree)) (node1 tree) (node2 tree) (node3 tree)
   ((1, r),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (increment_value r (node1 tree)) (node2 tree) (node3 tree)
   ((2, r),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (node1 tree) (increment_value r (node2 tree)) (node3 tree)
   ((3, r),        _)   -> RadixTrieNode (nodeValue tree) (node0 tree) (node1 tree) (node2 tree) (increment_value r (node3 tree))
...
new_inc_node existing = case existing of
   NullNode       -> RadixTrieNode (Just 1) NullNode NullNode NullNode NullNode
   x              -> case nodeValue x of
      Nothing		-> RadixTrieNode (Just 1)       (node0 x) (node1 x) (node2 x) (node3 x)
      Just y		-> RadixTrieNode (Just (1 + y)) (node0 x) (node1 x) (node2 x) (node3 x)
